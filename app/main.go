...
func main() {
	...
	http.HandleFunc("/multi_search/delete_route", middleware.Auth(multiroute.Delete))                       //削除用エンドポイント
	...
	http.HandleFunc("/simul_search/delete_route", middleware.Auth(simulsearch.Delete))                                         //編集用エンドポイント
